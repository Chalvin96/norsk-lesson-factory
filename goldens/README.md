...
## Notes
- These are hand-authored reference lessons. Their answer keys are authored by a human reviewer, not
  deterministically verified — acceptable for a reference artifact, NOT for shipped pipeline output
  (shipped keys stay deterministic).
