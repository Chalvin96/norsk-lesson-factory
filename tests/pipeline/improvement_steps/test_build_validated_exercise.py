...
from lesson_builder.pipeline.improvement_steps import add_exercises
...
def test_add_exercises_still_uses_build_validated_exercise():
    ...
    from lesson_builder.pipeline.improvement_steps.add_exercises import add_exercises as ae_func
