...
Current operating lessons after the v1, v2, v3, and 2026-06 reset work.

Retrospective notes. The lesson schema/authoring contract these lessons informed now lives in [SCHEMA.md](SCHEMA.md).
...
The bake-off and review-fix experiment settled this for Phase 1.

Findings:

- single-pass GPT-5.5 via Codex produced the best cost/quality result
...
Current active count: 106 lessons across A1, A2, B1, and B2.
