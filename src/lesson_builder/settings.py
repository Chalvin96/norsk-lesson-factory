...
K_LLM_LOG_PATH_ENV = "NORSK_LLM_LOG_PATH"
K_LLM_LOG_DEFAULT_PATH = "store/llm_calls.jsonl"

# ── LLM HTTP transient retry ────────────────────────────────────────────────

K_LLM_TRANSIENT_RETRIES = 1
K_LLM_TRANSIENT_BACKOFF_SECONDS = 2.0
