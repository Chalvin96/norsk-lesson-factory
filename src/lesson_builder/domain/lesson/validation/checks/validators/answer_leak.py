...
advisory check (``severity="warning"``, ``advisory=True``); it informs review
but does not route the gate.
...
from lesson_builder.domain.lesson.validation.checks.defect_rules import extract_stem_texts
from lesson_builder.domain.lesson.validation.checks.defect_rules import has_answer_leak
