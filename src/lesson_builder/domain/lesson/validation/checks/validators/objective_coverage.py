...
from lesson_builder.domain.lesson.validation.checks.defect_rules import section_coverage_gaps
    ...
    for oid in section_coverage_gaps(data):
        results.append(
            CheckResult(
                ...
                advisory=True,
                unit_id=oid,
                message=(f"objective '{oid}' is not covered by any section's objective_ids"),
                fix_hint=(
