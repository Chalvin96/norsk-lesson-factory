"""Shared naturalness/register style anchors.
...
REGISTER_POLICY = (
    "The terminology style guide is authoritative: pinned or Also OK glossary terms are not "
    "penalized merely for being technical. Standard textbook grammar terms are acceptable even "
    ...
    'infinitive", "modal verb", "present tense"). Unexplained label-dumps and invented labels '
    "are not acceptable; keep the learner action or plain explanation near the first technical "
    "label, and assume more terminology at higher levels. Pronunciation guidance must give an "
