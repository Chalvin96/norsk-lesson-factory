...
from lesson_builder.pipeline.nodes.add_exercises import add_exercises
from lesson_builder.pipeline.nodes.add_explanation import add_explanation
from lesson_builder.pipeline.nodes.feasibility import FeasibilityResult, feasibility_check
    ...
    *,
    ...
    if add_exercise:
        return ImprovementSpec(
            ...
            interpretation_summary=f"operation=add_exercises, target={slug or 'unknown'}, count={count}, bloom={bloom or 'any'}",
        )
